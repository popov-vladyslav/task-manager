...
export const tasks: Pick<Dictionary, keyof typeof import('../en/tasks').tasks> = {
  ...
  'tasks.deleteScope.title': 'Видалити повторювану задачу',
  'tasks.deleteScope.message': 'Ця задача повторюється. Видалити лише її чи зупинити всю серію?',
  'tasks.deleteScope.occurrence': 'Лише цю',
  'tasks.deleteScope.series': 'Всю серію',
