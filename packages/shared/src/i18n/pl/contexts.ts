...
export const contexts: Pick<Dictionary, keyof typeof import('../en/contexts').contexts> = {
  ...
  'contexts.editor.hideFromAll': 'Ukryj we „Wszystkie”',
  'contexts.editor.hideFromAllHint': 'Nadal widoczny w menu; zadania nie trafiają do „Wszystkie”.',
  ...
  'contexts.menu.showInAll': 'Pokaż we „Wszystkie”',
  ...
  'contexts.drawer.hiddenNote':
    'Ukryte kategorie pozostają na tej liście; ich zadania nie trafiają do „Wszystkie”.',
